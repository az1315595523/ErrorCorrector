...
logging.basicConfig(format='%(asctime)s - %(levelname)s - %(name)s -   %(message)s',
                    datefmt='%m/%d/%Y %H:%M:%S',
                    level=logging.INFO)
from Corrector.translation.parser import DFG_python, DFG_java, DFG_ruby, DFG_go, DFG_php, DFG_javascript, DFG_csharp
from Corrector.translation.parser import (remove_comments_and_docstrings,
                                          tree_to_token_index,
                                          index_to_code_token,
...
#     LANGUAGE = Language('Corrector/translation/parser/my-languages.so', lang)
#     parser = Parser()
